...
You will also need to compile the [HPS Linux Boot Tutorial Example Design User Guide: Agilex™ 3 FPGA and SoC C-Series](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-3/c-series/boot-examples/ug-linux-boot-agx3/).
...
3\. Power cycle the board. Board may configure from QSPI if there is a valid image, but that is OK as we will reconfigure the device.
...
```bash
quartus_pgm -c 1 -m jtag -o "p;agilex3_soc_devkit_ghrd/output_files/baseline_hps_debug.sof@2"
```

...
This page presents the Xen GSRD, which is based on the [Linux GSRD for the Agilex&trade; 5 E-Series Modular Development Kit](https://altera-fpga.github.io/rel-25.3.1/embedded-designs/agilex-5/e-series/modular/gsrd/ug-gsrd-agx5e-modular/). The Xen GSRD uses the SD card for storing the root filesystem.
...
The Agilex&trade; 5 Modular Development Kit GSRD binaries are located at [https://releases.rocketboards.org/2026.01/xen/agilex5_mk_a5e065bb32aes1_xen/](https://releases.rocketboards.org/2026.01/xen/agilex5_mk_a5e065bb32aes1_xen/).
...
| [GSRD Development Kit Section](https://altera-fpga.github.io/rel-25.3.1/embedded-designs/agilex-5/e-series/modular/gsrd/ug-gsrd-agx5e-modular/#development-kit) | Details about the development kit |
| [GSRD Board Setup Section](https://altera-fpga.github.io/rel-25.3.1/embedded-designs/agilex-5/e-series/modular/gsrd/ug-gsrd-agx5e-modular/#configure-board) | Setting up the development kit |
| [GSRD Serial Console Section](https://altera-fpga.github.io/rel-25.3.1/embedded-designs/agilex-5/e-series/modular/gsrd/ug-gsrd-agx5e-modular/#configure-serial-console)  | Setting up serial console |
| [GSRD Write SD Card Section](https://altera-fpga.github.io/rel-25.3.1/embedded-designs/agilex-5/e-series/modular/gsrd/ug-gsrd-agx5e-modular/#write-sd-card-image)  | Writing SD card image |
...
1\. Download and write to SD card the image [https://releases.rocketboards.org/2026.01/xen/agilex5_mk_a5e065bb32aes1_xen/sdimage.tar.gz](https://releases.rocketboards.org/2026.01/xen/agilex5_mk_a5e065bb32aes1_xen/sdimage.tar.gz)

2\. Download and write to QSPI flash the JIC file [https://releases.rocketboards.org/2026.01/xen/agilex5_mk_a5e065bb32aes1_xen/ghrd_a5ed065bb32ae6sr0.hps.jic.tar.gz](https://releases.rocketboards.org/2026.01/xen/agilex5_mk_a5e065bb32aes1_xen/ghrd_a5ed065bb32ae6sr0.hps.jic.tar.gz)
...
```bash
wget https://releases.rocketboards.org/2026.01/xen/agilex5_mk_a5e065bb32aes1_xen/xen-image-minimal-agilex5_modular.cpio.gz
...
```bash
fatls mmc 0:1
fatload  mmc 0:1 ${loadaddr} /devicetree/socfpga_agilex5_vanilla_modular.dtb
fatwrite mmc 0:1 ${loadaddr} /devicetree/socfpga_agilex5_vanilla_a0.dtb ${filesize}
fatload mmc 0:1 $loadaddr boot.scr.xen.uimg
source $loadaddr
booti 0x8a000000 - 0x88000000
```

Note: the above instructions make a copy if the file '/devicetree/socfpga_agilex5_vanilla_modular.dtb' to '/devicetree/socfpga_agilex5_vanilla_a0.dtb' to work around an issue in this release. This will be fixed in the future.
...
![](/rel-25.3.1/embedded-designs/agilex-5/e-series/premium/gsrd/images/agilex5-build-sd-flow.svg)
...
wget https://github.com/altera-fpga/agilex5e-ed-gsrd/releases/download/QPDS25.3.1_REL_GSRD_PR/a5ed065es-modular-devkit-som-legacy-baseline.zip

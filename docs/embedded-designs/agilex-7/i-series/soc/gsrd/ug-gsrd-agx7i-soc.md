...
# HPS GSRD User Guide for the Agilex™ 7 FPGA I-Series Transceiver-SoC Development Kit (4x F-Tile)
...
| Board | Binaries |
| :-- | :-- | 
| AGI027FB | [https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fb_gsrd/](https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fb_gsrd/) |
| AGI027FA | [https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fa_gsrd/](https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fa_gsrd/) |
| AGI027FC | [https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fc_gsrd/](https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fc_gsrd/) |
...
```bash 
wget https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fc_gsrd/sdimage.tar.gz 
...
- For DK-SI-AGI027FC board: [https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fc_gsrd/sdimage.tar.gz](https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fc_gsrd/sdimage.tar.gz)
...
```bash 
wget https://releases.rocketboards.org/2025.04/gsrd/agilex7_dk_si_agi027fc_gsrd/ghrd_agib027r31b1e1vb.jic.tar.gz 
...
1\. Open the Linux Device Tree [socfpga_agilex7_ghrd.dtsi](https://raw.githubusercontent.com/altera-fpga/meta-intel-fpga-refdes/nanbield/recipes-bsp/device-tree/files/socfpga_agilex7_ghrd.dtsi) file and look up the labels for the DIP switches and Push button GPIOs: 
...
- `$TOP_FOLDER/agilex7f-ed-gsrd/install/designs/agi027fc_si_devkit_oobe_baseline.sof` - FPGA configuration file, without HPS FSBL 
- `$TOP_FOLDER/agilex7f-ed-gsrd/install/designs/agi027fc_si_devkit_oobe_baseline_hps_debug.sof` - FPGA configuration file, with HPS Debug FSBL 
...
cd $TOP_FOLDER 
rm -f *jic* *rbf* 
quartus_pfg -c agilex7f-ed-gsrd/install/designs/agi027fc_si_devkit_oobe_baseline_hps_debug.sof \
...
- [fit_kernel_agilex7_dk_si_agi027fc.its](https://github.com/altera-fpga/meta-intel-fpga-refdes/blob/scarthgap/recipes-kernel/linux/linux-socfpga-lts/fit_kernel_agilex7_dk_si_agi027fc.its) - its file for creating the kernel.itb image 
...
cd $TOP_FOLDER 
rm -f *jic* *rbf* 
quartus_pfg -c agilex7f-ed-gsrd/install/designs/agi027fc_si_devkit_oobe_baseline.sof \
 ghrd_agib027r31b1e1vb.jic \

...
The GSRD binaries are located at [https://releases.rocketboards.org/2025.10/gsrd/agilex7_dk_dev_agf023fa_gsrd/](https://releases.rocketboards.org/2025.10/gsrd/agilex7_dk_dev_agf023fa_gsrd)
...
```bash 
cd $TOP_FOLDER 
wget https://releases.rocketboards.org/2025.10/gsrd/agilex7_dk_dev_agf023fa_gsrd/ghrd_agfd023r24c2e1vc.hps.jic.tar.gz 
...
```bash 
wget https://releases.rocketboards.org/2025.10/gsrd/agilex7_dk_dev_agf023fa_gsrd/sdimage.tar.gz 
...
1\. Download the SD card from [https://releases.rocketboards.org/2025.10/gsrd/agilex7_dk_dev_agf023fa_gsrd/sdimage.tar.gz](https://releases.rocketboards.org/2025.10/gsrd/agilex7_dk_dev_agf023fa_gsrd/sdimage.tar.gz) and extract it. 

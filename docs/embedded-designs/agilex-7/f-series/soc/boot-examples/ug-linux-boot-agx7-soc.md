...
This section presents examples of how to run U-Boot with the Arm Development Studio from command line. This offers a simple and convenient way to run U-Boot and use it for example to program onboard flash.
  ...
  --cdb-entry="Altera SoC FPGA::Agilex 7 SoC::Bare Metal Debug::Bare Metal Debug::Cortex-A53x4 SMP::Altera FPGA Download Cable"  \
  --cdb-entry-param="rvi_address=Agilex 7 SI/SoC Dev Kit on localhost [3-4.3.4]:Agilex SI/SoC Dev Kit 3-4.3.4"  \
...
### Debugging SPL
  ...
  a) Go to **Select target** section and select **Altera® SoC FPGA > Agilex > Bare Metal Debug > Cortex-A53x4 SMP**<br>
...
#### Build Arm Trusted Firmware for SDCard (ATF-To-Linux)
  ...
  make bl2 bl31 PLAT=agilex fiptool ARM_LINUX_KERNEL_AS_BL33=1 SOCFPGA_BOOT_SOURCE_SDMMC=1 PRELOADED_BL33_BASE=0x02000000 ARM_PRELOADED_DTB_BASE=0x10000000 
  cd ..
  ```
...
* $TOP_FOLDER/arm-trusted-firmware-sdcard/build/agilex/release/tools/fiptool/fiptool
...
#### Build Linux for SDCard (ATF-To-Linux)
  ...
  sed -i 's/ttys/ttyS/g' arch/arm64/boot/dts/intel/socfpga_agilex_socdk_sdmmc_atfboot.dts
...
* $TOP_FOLDER/linux-socfpga-sdcard/arch/arm64/boot/dts/intel/socfpga_agilex_socdk_sdmmc_atfboot.dtb
...
#### Build SD Card image with FIP inside (ATF-To-Linux)
  ...
  $TOP_FOLDER/arm-trusted-firmware-sdcard/build/agilex/release/tools/fiptool/fiptool create \
  ...
  --nt-fw-config $TOP_FOLDER/linux-socfpga-sdcard/arch/arm64/boot/dts/intel/socfpga_agilex_socdk_sdmmc_atfboot.dtb fip.bin
...
#### Build Arm Trusted Firmware for QSPI (ATF-To-Linux)
  ...
  make realclean
  make bl2 bl31 PLAT=agilex fiptool ARM_LINUX_KERNEL_AS_BL33=1 SOCFPGA_BOOT_SOURCE_QSPI=1 PRELOADED_BL33_BASE=0x02000000 ARM_PRELOADED_DTB_BASE=0x10000000 DEBUG=0
  cd ..
  ```
...
* $TOP_FOLDER/arm-trusted-firmware-qspi/build/agilex/release/tools/fiptool/fiptool
...
#### Build Linux for QSPI (ATF-To-Linux)
  ...
  # WA: ES-1522 Incorrect name of ttyS0 serial console
  sed -i 's/ttys/ttyS/g' arch/arm64/boot/dts/intel/socfpga_agilex_socdk_qspi_atfboot.dts
...
* $TOP_FOLDER/linux-socfpga-qspi/arch/arm64/boot/dts/intel/socfpga_agilex_socdk_qspi_atfboot.dtb
...
#### Create QSPI JIC image for QSPI Boot (ATF-To-Linux)
  ...
  cd $TOP_FOLDER
  # Create FIP image
  ./arm-trusted-firmware-qspi/build/agilex/release/tools/fiptool/fiptool create --soc-fw arm-trusted-firmware-qspi/build/agilex/release/bl31.bin \
  --nt-fw $TOP_FOLDER/linux-socfpga-qspi/arch/arm64/boot/Image \
  --nt-fw-config $TOP_FOLDER/linux-socfpga-qspi/arch/arm64/boot/dts/intel/socfpga_agilex_socdk_qspi_atfboot.dtb fip.bin

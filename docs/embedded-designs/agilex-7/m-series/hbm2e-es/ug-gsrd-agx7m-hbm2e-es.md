...
This page presents the HPS Baseline System Example Design (formerly known as "GSRD" or "Golden System Reference Design") for the Agilex™ 7 FPGA M-Series Development Kit - HBM2e Edition (3x F-Tile & 1x R-Tile) ES.

- Quartus Design
  - LEDs connected to GPIO soft IP modules 
  - DIP switches and push buttons connected to GPIO soft IP modules 
- HPS Software
  - Linux, booted by U-Boot
  - Board web server 
  - Sample driver 
...
- [Agilex™ 7 FPGA M-Series Development Kit - HBM2e Edition (3x F-Tile & 1x R-Tile) ES](https://www.altera.com/products/devkit/po-3016/agilex-7-fpga-m-series-development-kit-hbm2e-edition-3x-f-tile-1x-r-tile-es), ordering code DK-DEV-AGM039FES
...
This page covers the DK-DEV-AGM039FES version of the board. You can identify your board type by looking at the serial number identifier, as shown below:

| Development Kit Version | Ordering Code | Device Part Number | Serial Number Identifier |
| :-- | :-- |  :-- |  :-- |
| Agilex™ 7 FPGA M-Series Development Kit - HBM2e Edition (3x F-Tile and 1x R-Tile) | DK-DEV-AGM039FES | 	AGMF039R47A1E1VC | AGM82DK0001001 |
...
* DK-DEV-AGM039FES uses HBM memory for HPS
...
The Intel FPGA HPS Embedded Software release notes can be accessed from the following link: [https://github.com/altera-fpga/gsrd-socfpga/releases/tag/QPDS26.1.1_REL_GSRD_PR](https://github.com/altera-fpga/gsrd-socfpga/releases/tag/QPDS26.1.1_REL_GSRD_PR)

### Binary Release Contents 

The binary release files are accessible at [https://releases.rocketboards.org/2026.08/gsrd/agilex7_dk_dev_agm039fes_gsrd/](https://releases.rocketboards.org/2026.08/gsrd/agilex7_dk_dev_agm039fes_gsrd/).
...
2\. Download, extract and write to SD card the following SD card image: [https://releases.rocketboards.org/2026.08/gsrd/agilex7_dk_dev_agm039fes_gsrd/sdimage.tar.gz](https://releases.rocketboards.org/2026.08/gsrd/agilex7_dk_dev_agm039fes_gsrd/sdimage.tar.gz)
...
```bash 
wget https://releases.rocketboards.org/2026.08/gsrd/agilex7_dk_dev_agm039fes_gsrd/ghrd.hps.rbf 
...
```bash 
root@agilex7dkdevagm039:~# cd alteraFPGA/ 
root@agilex7dkdevagm039:~/alteraFPGA# ./hello 
Hello SoC FPGA! 
```
...
```bash 
root@agilex7dkdevagm039:~/alteraFPGA# ./syschk 
```
...
## Rebuild the System Example Design
...
- `agilex7_dk_dev_agm039fes-gsrd-images`: the build script copies here relevant files built by Yocto from the `agilex7_dk_dev_agm039fes-gsrd-rootfs/tmp/deploy/images/agilex7_dk_dev_agm039fes/` folder, but also other relevant files. 
...
This section provides the details on how the PFG file is created. The steps required to create the file are: 
...
The provided [ghrd_agmf039r47a1e2vr0.cdf](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-7/m-series/hbm2e/collateral/ghrd_agmf039r47a1e2vr0.cdf)) file contains the configuration required for the Quartus Programmer to be able to write the POF file to the QSPI attached to the MAX 10 Board Controller. 
...
**Note**: The output file "ghrd_agmf039r47a1e2vr0.cdf" has an absolute path to the "ghrd_agmf039r47a1e2vr0.pof" file. You can hand edit it to use a relative path instead, so files could be located anywhere on the host PC file system. 

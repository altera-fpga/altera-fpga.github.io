...
| :-- | :-- |
| [stratix10-ed-gsrd](https://github.com/altera-fpga/stratix10-ed-gsrd) | QPDS25.1_REL_GSRD_PR |
...
1. Power cycle the board and press any key when prompted, to get to the U-Boot command prompt.
    ...
    ```bash 
    U-Boot SPL 2025.01-35102-g135e53726d-dirty (Jan 28 2025 - 13:23:54 -0600)
    Reset state: Cold
    MPU         1200000 kHz
    L3 main     400000 kHz

...
<!--This file is used for listing inter-document links in the embedded-designs folder.  Create a live link when you want to ensure the naming of the file is always the same.  Share your agreed upon bracketed document name with others in this link file and whenever it is listed, the correct active links will be populated in the document.  This links.md also helps if the link path changes, so you don't have to go back and change all of your documentation.  Steps to get this to work are:
...
[GSRD User Manual]: https://altera-fpga.github.io/${{ env.ALTERA_release }}/docs/embedded-designs/agilex-5/e-series/premium/gsrd/ug-gsrd-agx5e-premium/

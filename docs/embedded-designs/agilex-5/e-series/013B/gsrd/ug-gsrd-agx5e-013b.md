...
* Altera&reg; Agilex&trade; 5 FPGA E-Series 013B Development Kit, ordering code DK-A5E013BM16AEA. Refer to [board documentation](https://www.intel.com/content/www/us/en/docs/programmable/860700/current/overview.html) for more information about the development kit.
...
The Agilex&trade; 5 FPGA E-Series 013B Development Kit GSRD binaries are located at [https://releases.rocketboards.org/2026.01/](https://releases.rocketboards.org/2026.01/):

| Boot Source | Link |
| ---------------------- | -- |
| SD Card | [https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e013bm16aea_gsrd](https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e013bm16aea_gsrd) |
| QSPI | [https://releases.rocketboards.org/2026.01/qspi/agilex5_dk_a5e013bm16aea_gsrd](https://releases.rocketboards.org/2026.01/qspi/agilex5_dk_a5e013bm16aea_gsrd) |
...
This release targets the Agilex 5 FPGA E-Series 013B Development Kit. Refer to [board documentation](https://www.intel.com/content/www/us/en/docs/programmable/860700/current/overview.html) for more information about the development kit.
...
1\. Download SD card image from the prebuilt binaries [https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e013bm16aea_gsrd/sdimage.tar.gz](https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e013bm16aea_gsrd/sdimage.tar.gz) and extract the archive, obtaining the file `gsrd-console-image-agilex5.wic`.
...
```bash
wget https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e013bm16aea_gsrd/ghrd_a5ed013bm16ae4scs.hps.jic.tar.gz
...
3\. Download and extract the JIC image, then write it to QSPI:
```bash
wget https://releases.rocketboards.org/2026.01/qspi/agilex5_dk_a5e013bm16aea_qspi/ghrd_a5ed013bm16ae4scs.hps.jic.tar.gz
tar xf ghrd_a5ed013bm16ae4scs.hps.jic.tar.gz
jtagconfig --setparam 1 JtagClock 16M
...
![](images/agilex5-013b-build-sd-flow.svg)
...
```bash
sudo rm -rf agilex5-013b_gsrd
mkdir agilex5-013b_gsrd
cd agilex5-013b_gsrd
...
* `$TOP_FOLDER/agilex5_soc_devkit_ghrd/install/binaries/legacy_baseline_hps_debug.sof`
...
```bash
cd $TOP_FOLDER
rm -f ghrd_a5ed013bm16ae4scs.rbf
quartus_pfg -c agilex5_soc_devkit_ghrd/install/binaries/legacy_baseline_hps_debug.sof ghrd_a5ed013bm16ae4scs.rbf -o hps=1
```


The following file is created:

* `$TOP_FOLDER/ghrd_a5ed013bm16ae4scs.core.rbf`
...
cd $TOP_FOLDER
rm -rf gsrd-socfpga
git clone -b QPDS25.3.1_REL_AGILEX5_013B_GSRD_PR https://github.com/altera-fpga/gsrd-socfpga
cd gsrd-socfpga
. agilex5_dk_a5e013bm16aea-gsrd-build.sh
build_setup
```
...
1\. Save the `core.rbf` as `$WORKSPACE/meta-intel-fpga-refdes/recipes-bsp/ghrd/files/agilex5_dk_a5e013bm16aea_gsrd_ghrd.core.rbf`

2\. Update the recipe `$WORKSPACE/meta-intel-fpga-refdes/recipes-bsp/ghrd/hw-ref-design.bb` as follows:  

* Replace the entry `${GHRD_REPO}/agilex5_dk_a5e013bm16aea_gsrd_${ARM64_GHRD_CORE_RBF};name=agilex5_dk_a5e013bm16aea_gsrd_core` with `file://agilex5_dk_a5e013bm16aea_gsrd_ghrd.core.rbf;sha256sum=<CORE_SHA>` where `CORE_SHA` is the sha256 checksum of the file
* Delete the line `SRC_URI[agilex5_dk_a5e013bm16aea_gsrd_core.sha256sum] = "fc066f59644f4ebb3937f2d49fae4fca0d3805074ec0d4d58fbb00249b14cf9f"`
The above are achieved by the following instructions:

```bash
CORE_RBF=$WORKSPACE/meta-intel-fpga-refdes/recipes-bsp/ghrd/files/agilex5_dk_a5e013bm16aea_gsrd_ghrd.core.rbf
ln -s $TOP_FOLDER/ghrd_a5ed013bm16ae4scs.core.rbf $CORE_RBF
OLD_URI="\${GHRD_REPO}\/agilex5_dk_a5e013bm16aea_gsrd_\${ARM64_GHRD_CORE_RBF};name=agilex5_dk_a5e013bm16aea_gsrd_core"
CORE_SHA=$(sha256sum $CORE_RBF | cut -f1 -d" ")
NEW_URI="file:\/\/agilex5_dk_a5e013bm16aea_gsrd_ghrd.core.rbf;sha256sum=$CORE_SHA"
sed -i "s/$OLD_URI/$NEW_URI/g" $WORKSPACE/meta-intel-fpga-refdes/recipes-bsp/ghrd/hw-ref-design.bb
sed -i "/agilex5_dk_a5e013bm16aea_gsrd_core\.sha256sum/d" $WORKSPACE/meta-intel-fpga-refdes/recipes-bsp/ghrd/hw-ref-design.bb
```
...
* `$TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-gsrd-images/u-boot-agilex5-socdk-gsrd-atf/u-boot-spl-dtb.hex`
* `$TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-gsrd-images/sdimage.tar.gz`
...
```bash
cd $TOP_FOLDER
rm -f ghrd_a5ed013bm16ae4scs.hps.jic ghrd_a5ed013bm16ae4scs.core.rbf
quartus_pfg \
...
* `$TOP_FOLDER/ghrd_a5ed013bm16ae4scs.hps.jic`
...
```bash
cd $TOP_FOLDER
rm -f ghrd_a5ed013bm16ae4scs.hps.rbf
quartus_pfg \
-c agilex5_soc_devkit_ghrd/install/binaries/legacy_baseline.sof ghrd_a5ed013bm16ae4scs.rbf \
-o hps_path=gsrd-socfpga/agilex5_dk_a5e013bm16aea-gsrd-images/u-boot-agilex5-socdk-gsrd-atf/u-boot-spl-dtb.hex \
-o hps=1
```
...
* `$TOP_FOLDER/ghrd_a5ed013bm16ae4scs.hps.rbf`
...
![](images/agilex5-013b-build-qspi-flow.svg)
...
```bash
sudo rm -rf agilex5-013b_gsrd-qspi
mkdir agilex5-013b_gsrd-qspi
cd agilex5-013b_gsrd-qspi
export TOP_FOLDER=`pwd`
```
...
git clone -b QPDS25.3.1_REL_AGILEX5_013B_GSRD_PR https://github.com/altera-fpga/gsrd-socfpga
cd gsrd-socfpga
 . agilex5_dk_a5e013bm16aea-qspi-build.sh
build_setup
```
...
* `$TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/core-image-minimal-agilex5_nor.ubifs`
* `$TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/u-boot-agilex5-socdk-qspi-atf/u-boot.itb`
* `$TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/u-boot-agilex5-socdk-qspi-atf/u-boot-spl-dtb.hex`
* `$TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/kernel.itb`
* `$TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/u-boot-agilex5-socdk-qspi-atf/boot.scr.uimg`
  

<h5>Create QSPI Image</h5>

1\. Get the `ubinize.cfg` file which contains the details on how to build the `root.ubi` volume, and `agilex5_devkit_flash_image_hps.pfg` which contains the instructions for Programming File Generator on how to create the .jic file:
...
```bash
cd $TOP_FOLDER
wget https://releases.rocketboards.org/2026.01/qspi/agilex5_dk_a5e013bm16aea_qspi/ubinize.cfg
wget https://releases.rocketboards.org/2026.01/qspi/agilex5_dk_a5e013bm16aea_qspi/agilex5_devkit_flash_image_hps.pfg
sed -i 's/ghrd_a5ed013bm16ae4scs\.sof/legacy_baseline.sof/g' agilex5_devkit_flash_image_hps.pfg 
```
...
```bash
cd $TOP_FOLDER
ln -s $TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/core-image-minimal-agilex5_nor.ubifs rootfs.ubifs
ln -s $TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/kernel.itb .
ln -s $TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/u-boot-agilex5-socdk-qspi-atf/boot.scr.uimg .
ln -s $TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/u-boot-agilex5-socdk-qspi-atf/u-boot-spl-dtb.hex .
ln -s $TOP_FOLDER/agilex5_soc_devkit_ghrd/install/binaries/legacy_baseline.sof .
```
...
```bash
cp $TOP_FOLDER/gsrd-socfpga/agilex5_dk_a5e013bm16aea-qspi-images/u-boot-agilex5-socdk-qspi-atf/u-boot.itb .

...
`doc-variants` repository, within the `sw` directory see: [meta-driveonchip](https://github.com/altera-fpga/agilex-ed-drive-on-chip/tree/rel/24.3/sw/meta-driveonchip).
...
(see: [agilex-ed-drive-on-chip/sw](https://github.com/altera-fpga/agilex-ed-drive-on-chip/tree/rel/24.3/sw)). An it is compose of two main meta-layers. In this
...
* See **[meta-fpga-embedded](https://github.com/altera-fpga/agilex-ed-drive-on-chip/tree/rel/24.3/sw/meta-fpga-embedded)**

### Drive-On-Chip Layer

* See **[meta-driveonchip](https://github.com/altera-fpga/agilex-ed-drive-on-chip/tree/rel/24.3/sw/meta-driveonchip)**
...
in the [Hard Processor System Technical Reference Manual: Agilex™ 5 SoCs (24.3)](https://www.intel.com/content/www/us/en/docs/programmable/814346/24-3/hard-processor-system-technical-reference.html))

...
# 4Kp30 Multi-Sensor Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices - RBF Modular Design Toolkit (MDT) Flow
...
[Agilex™ 5 FPGA E-Series 065B Modular Development Kit](https://www.altera.com/products/devkit/a1jui0000061qabmaa/agilex-5-fpga-and-soc-e-series-modular-development-kit-es). You will build new
`RBF` and `JIC` files using the Modular Development Toolkit, and a new microSD
Card image using [KAS](https://kas.readthedocs.io/en/latest/) and Yocto (suitable for use with fully licensed IP cores).

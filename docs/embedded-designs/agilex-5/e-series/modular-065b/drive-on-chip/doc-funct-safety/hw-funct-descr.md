...
Devices" see [AN 999: Drive-on-Chip with Functional Safety Design Example: Agilex™ 7 Devices](https://docs.altera.com/r/docs/823627/current/an-999-drive-on-chip-with-functional-safety-design-example-agilextm-7-devices)
and [AN 1000: Drive-on-Chip Design Example: Agilex™ 5 Devices](https://docs.altera.com/r/docs/826207/current).
...
More details about these blocks can be found in Application Notes [AN 999: Drive-on-Chip with Functional Safety Design Example: Agilex™ 7 Devices](https://docs.altera.com/r/docs/823627/current/an-999-drive-on-chip-with-functional-safety-design-example-agilextm-7-devices) and [AN 1000: Drive-on-Chip Design Example: Agilex™ 5 Devices](https://docs.altera.com/r/docs/826207/current)

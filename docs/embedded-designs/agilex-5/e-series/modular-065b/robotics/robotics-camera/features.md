...
* **ISP In + ISP Lite conditioning:** Bayer input selection, test-pattern debug support, and first-stage image processing
  (black-level correction, white balance, demosaic, and color correction).

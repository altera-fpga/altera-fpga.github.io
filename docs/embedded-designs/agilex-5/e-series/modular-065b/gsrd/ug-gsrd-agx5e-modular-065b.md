...
Boot Source | Link |
| ---------------------- | -- |
| SD Card | [https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065bb32aea_gsrd.baseline-a55/](https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065bb32aea_gsrd.baseline-a55/) |
| QSPI | [https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065bb32aea_qspi.baseline-a55/](https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065bb32aea_qspi.baseline-a55/) |
...
1\. Download SD card image from the prebuilt binaries [https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065bb32aea_gsrd.baseline-a55/sdimage.tar.gz](https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065bb32aea_gsrd.baseline-a55/sdimage.tar.gz) and extract the archive, obtaining the file `gsrd-console-image-agilex5e.rootfs.wic`.
...
```bash
wget https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065bb32aea_gsrd.baseline-a55/ghrd.hps.jic
...
4\. Download and extract the JIC image, then write it to QSPI:
```bash
wget https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065bb32aea_qspi.baseline-a55/qspi_boot.hps.jic
jtagconfig --setparam 1 JtagClock 16M
...
The GSRD 2.0 software source code is released inside the [software/yocto_linux](https://github.com/altera-fpga/agilex5e-ed-gsrd/tree/QPDS26.1.1_REL_GSRD_PR/a5ed065b-modular-devkit-som/baseline-a55/software/yocto_linux) directory of the Agilex 5 E-Series Golden Hardware Reference Design (GHRD). Accessing the link will display a README page with details on how the GSRD 2.0 is organized around the Kas tool.
...
wget https://github.com/altera-fpga/agilex5e-ed-gsrd/releases/download/QPDS26.1.1_REL_GSRD_PR/a5ed065b-modular-devkit-som-baseline-a55.zip
...
```bash
wget https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065bb32aea_qspi.baseline-a55/ubinize_nor.cfg
wget https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065bb32aea_qspi.baseline-a55/qspi_boot.pfg
wget https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065bb32aea_qspi.baseline-a55/uboot.env
```
...
Review the kas.yml file, the Kconfig options and associated documentation at [https://github.com/altera-fpga/agilex5e-ed-gsrd/tree/QPDS26.1.1_REL_GSRD_PR/a5ed065b-modular-devkit-som/baseline-a55/software/yocto_linux](https://github.com/altera-fpga/agilex5e-ed-gsrd/tree/QPDS26.1.1_REL_GSRD_PR/a5ed065b-modular-devkit-som/baseline-a55/software/yocto_linux).

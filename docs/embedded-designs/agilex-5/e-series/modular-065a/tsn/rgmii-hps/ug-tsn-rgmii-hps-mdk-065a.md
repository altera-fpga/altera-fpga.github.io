...
The Time Sensitive Network (TSN) through Hard Processor System (HPS) IO System Example Design (SED) is a reference design running on the Agilex&trade; 5 E-Series 065A Modular Development Kit.  
...
>[Note:]
>This is a pre-production release of Agilex&trade; 5 TSN HPS RGMII System Example Design, on Agilex&trade; 5 FPGA E-Series 065A Modular Development Kit.


### Prerequisites

This system example design is based on the [Agilex 5 E-Series Modular Development Kit GSRD](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-5/e-series/modular-065a/gsrd/ug-gsrd-agx5e-modular-065a/). It is recommended that you familiarize yourself with the GSRD development flow before proceeding with this design.
...
This Example Design targets the Agilex 5 FPGA E-Series 065A Modular Development Kit, utilizing the HPS. 
Refer to [GSRD\#Development Kit](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-5/e-series/modular-065a/gsrd/ug-gsrd-agx5e-modular-065a/#development-kit) for details about the board, including how to install the HPS Daughter Card.

* Altera&reg; Agilex&trade; 5 FPGA E-Series 065A Modular Development Kit
...
![Agilex 5 FPGA E-Series 065A Modular Development Kit](images/agilex5_modular_devkit.png)
...
* See [HPS GSRD User Guide for the Agilex™ 5 E-Series Modular Dev Kit](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-5/e-series/modular-065a/gsrd/ug-gsrd-agx5e-modular-065a/)
  
  * See Prerequisites
  * See [Prebuild Binaries](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-5/e-series/modular-065a/gsrd/ug-gsrd-agx5e-modular-065a/#prebuilt-binaries)
...
* User Flow 1: [Testing with Prebuilt Binaries](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-5/e-series/modular-065a/gsrd/ug-gsrd-agx5e-modular-065a/#exercising-prebuilt-binaries)

    <a id="UserFlow2"></a>

* User Flow 2: [Testing Complete Flow build GSRD 2.0](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-5/e-series/modular-065a/gsrd/ug-gsrd-agx5e-modular-065a/#build-gsrd-20-binaries)

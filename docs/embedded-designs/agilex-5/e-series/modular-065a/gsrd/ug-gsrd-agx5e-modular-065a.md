...
Boot Source | Link |
| ---------------------- | -- |
| SD Card | [https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065ab32aea_gsrd.baseline-a55/](https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065ab32aea_gsrd.baseline-a55/) |
| QSPI | [https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065ab32aea_qspi.baseline-a55/](https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065ab32aea_qspi.baseline-a55/) |
...
1\. Download SD card image from the prebuilt binaries [https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065ab32aea_gsrd.baseline-a55/sdimage.tar.gz](https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065ab32aea_gsrd.baseline-a55/sdimage.tar.gz) and extract the archive, obtaining the file `gsrd-console-image-agilex5e.rootfs.wic`.
...
```bash
wget https://releases.rocketboards.org/2026.08/gsrd/agilex5_mk_a5e065ab32aea_gsrd.baseline-a55/ghrd.hps.jic
...
4\. Download and extract the JIC image, then write it to QSPI:
```bash
wget https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065ab32aea_qspi.baseline-a55/qspi_boot.hps.jic
jtagconfig --setparam 1 JtagClock 16M
...
```bash
wget https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065ab32aea_qspi.baseline-a55/ubinize_nor.cfg
wget https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065ab32aea_qspi.baseline-a55/qspi_boot.pfg
wget https://releases.rocketboards.org/2026.08/qspi/agilex5_mk_a5e065ab32aea_qspi.baseline-a55/uboot.env
```

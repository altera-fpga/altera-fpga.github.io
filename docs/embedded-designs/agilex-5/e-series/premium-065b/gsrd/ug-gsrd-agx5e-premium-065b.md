...
```bash
wget https://releases.rocketboards.org/2026.08/emmc/agilex5_dk_a5e065bb32aea_emmc/sdimage.tar.gz
...
```bash
wget https://releases.rocketboards.org/2026.08/emmc/agilex5_dk_a5e065bb32aea_emmc/qspi_helper.hps.jic
jtagconfig --setparam 1 JtagClock 16M
...
```bash
wget https://releases.rocketboards.org/2026.08/emmc/agilex5_dk_a5e065bb32aea_emmc/ghrd.hps.jic 
jtagconfig --setparam 1 JtagClock 16M
quartus_pgm -c 1 -m jtag -o "pvi;ghrd.hps.jic"
```
<h5>Boot Linux</h5>
...
```bash
wget https://releases.rocketboards.org/2026.08/nand/agilex5_dk_a5e065bb32aea_nand/qspi_helper.hps.jic
jtagconfig --setparam 1 JtagClock 16M
quartus_pgm -c 1 -m jtag -o "pvi;qspi_helper.hps.jic"
```
...
4\. Download the JIC and write it to QSPI:
```bash
wget https://releases.rocketboards.org/2026.08/nand/agilex5_dk_a5e065bb32aea_nand/ghrd.hps.jic 
jtagconfig --setparam 1 JtagClock 16M
quartus_pgm -c 1 -m jtag -o "pvi;ghrd.hps.jic
```
<h5>Boot Linux</h5>
...
1\. Download SD card image from the prebuilt binaries https://releases.rocketboards.org/2026.08/debug/agilex5_dk_a5e065bb32aes1_debug/sdimage.tar.gz and extract the archive, obtaining the file `gsrd-console-image-agilex5_devkit.wic`.
...
4\. Download the JIC and write it to QSPI:
```bash
wget https://releases.rocketboards.org/2026.08/debug/agilex5_dk_a5e065bb32aes1_debug/ghrd_a5ed065bb32ae6sr0.hps.jic.tar.gz 
...
The software source code for this System Example Design is released inside the [software/yocto_linux](https://github.com/altera-fpga/agilex5e-ed-gsrd/tree/QPDS26.1.1_REL_GSRD_PR/a5ed065b-premium-devkit-oobe/baseline/software/yocto_linux) directory. Accessing the link will display a README page with details regarding the software.
...
cd $TOP_FOLDER
rm -rf agilex5_soc_devkit_ghrd && mkdir agilex5_soc_devkit_ghrd && cd agilex5_soc_devkit_ghrd
wget https://github.com/altera-fpga/agilex5e-ed-gsrd/releases/download/QPDS26.1.1_REL_GSRD_PR/a5ed065b-premium-devkit-emmc-baseline-a55.zip
...
cd $TOP_FOLDER
rm -rf agilex5_soc_devkit_ghrd && mkdir agilex5_soc_devkit_ghrd && cd agilex5_soc_devkit_ghrd
wget https://github.com/altera-fpga/agilex5e-ed-gsrd/releases/download/QPDS26.1.1_REL_GSRD_PR/a5ed065b-premium-devkit-nand-baseline-a55.zip
...
cd $TOP_FOLDER
rm -rf agilex5_soc_devkit_ghrd && mkdir agilex5_soc_devkit_ghrd && cd agilex5_soc_devkit_ghrd
wget https://github.com/altera-fpga/agilex5e-ed-gsrd/releases/download/QPDS26.1.1_REL_GSRD_PR/a5ed065b-premium-devkit-debug2-baseline-a55.zip
...
Review the kas.yml file, the Kconfig options and associated documentation at [https://github.com/altera-fpga/agilex5e-ed-gsrd/tree/QPDS26.1.1_REL_GSRD_PR/a5ed065b-premium-devkit-oobe/baseline-a55/software/yocto_linux](https://github.com/altera-fpga/agilex5e-ed-gsrd/tree/QPDS26.1.1_REL_GSRD_PR/a5ed065b-premium-devkit-oobe/baseline-a55/software/yocto_linux).

...
This page demonstrates how to use RiscFree* to debug a Linux application running on the Agilex 5 FPGA E-Series 065B Premium Development Kit. For further information about RiscFree*, visit [The Ashling RiscFree IDE for Altera® FPGAs](https://www.altera.com/products/development-tools/ashling).
...
2\. Write SD card image `$TOP_FOLDER/gsrd-console-image-agilex5e.rootfs.wic` to the micro SD card and insert it into the socket on the HPS Expansion Board.
...
Poky (Yocto Project Reference Distro) 5.0.16 agilex5 ttyS0
...
```bash
root@agilex5:~# scp radu@big-machine.local:/home/radu/riscfree-linux-app-debug/application .

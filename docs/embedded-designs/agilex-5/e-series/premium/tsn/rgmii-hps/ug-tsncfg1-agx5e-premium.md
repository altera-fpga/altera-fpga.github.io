...
*   The prebuilt binaries were built using Altera&reg; Quartus&reg; 25.3.1
*   The instructions for rebuilding the binaries use Altera&reg; Quartus&reg; 25.3.1
...
The Agilex 5 Premium Development Kit 25.3.1 Example Design binaries are located at
[https://releases.rocketboards.org/2026.01/](https://releases.rocketboards.org/2026.01/)

| HPS Daughter Card | Boot Source | Link |
| --- | --- | --- |
| Enablement Board | SD Card | [https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e065bb32aes1_gsrd](https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e065bb32aes1_gsrd) |
...
| :------------------------------------ | :----------------------------------------------------------- | :--------------------------- | :------------------ |
| Agilex 5 GHRD                                  | [https://github.com/altera-fpga/agilex5e-ed-gsrd](https://github.com/altera-fpga/agilex5e-ed-gsrd) | main                    | QPDS25.3.1_REL_GSRD_PR |
...
See [https://github.com/altera-opensource/gsrd-socfpga/releases/tag/QPDS25.3.1_REL_GSRD_PR](https://github.com/altera-opensource/gsrd-socfpga/releases/tag/QPDS25.3.1_REL_GSRD_PR)
...
1. Quartus Prime Pro
     - Please download and install the Quartus&reg; Pro 25.3.1 version software. 
...
```bash
export export QUARTUS_ROOTDIR=~/altera_pro/25.3.1/quartus/
...
wget https://github.com/altera-fpga/agilex5e-ed-gsrd/releases/download/QPDS25.3.1_REL_GSRD_PR/a5ed065es-premium-devkit-oobe-legacy-baseline.zip
...
```bash
cd $TOP_FOLDER
wget https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e065bb32aes1_gsrd/ghrd_a5ed065bb32ae6sr0.hps.jic.tar.gz
...
- Download SD card image from the prebuilt binaries [https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e065bb32aes1_gsrd/sdimage.tar.gz](https://releases.rocketboards.org/2026.01/gsrd/agilex5_dk_a5e065bb32aes1_gsrd/sdimage.tar.gz) and extract the archive, obtaining the file `gsrd-console-image-agilex5_devkit.wic`.

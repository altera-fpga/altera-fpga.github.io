...
**Note:** To build binaries for a different development kit than the one used in this page, please refer to the [Building the Quartus Project](#building-the-quartus-project) section in the **HPS Baseline System Example Design User Guide** page for that development kit, which is the section that may differ from the instructions presented here.
...
9. In the **Input Files** tab click the **Add Bitstream** button, then browse to **$TOP_FOLDER/agilex5_soc_devkit_ghrd_a55/output_files**, select the file **baseline_a55.sof**, and then click **Open**. This is the initial factory image. Do the same for the **$TOP_FOLDER/hw/agilex5_soc_devkit_ghrd_a55/baseline_a55.sof** image. This is the initial application image. The tab now looks like below.
